...
<?php
    ...
    echo  $noticeTitle, $noticeContents, $youId;
    ...
    if(!isset($_SESSION['youId'])) {
        ...
        //데이터 입력 여부
        if(empty($noticeTitle) || empty($noticeContents)){
            ...
            $sql = "INSERT INTO noticeboard(youId, noticeTitle, noticeContents, noticeView, regTime) VALUES('$youId', '$noticeTitle','$noticeContents', '$noticeView', '$regTime')";
            $connect -> query($sql);
