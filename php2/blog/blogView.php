...
// 댓글 정보 가져오기
$commentSql = "SELECT * FROM blogComment WHERE blogId='$blogId' AND commentDelete = '1' ORDER BY commentId ASC"; // $connectSql을 $commentSql로 수정
$commentResult = $connect->query($commentSql); // $commentReselt를 $commentResult로 수정
                        ...
                        <!-- <div class="comment__view">
                            ...
                            <div class="text">
                                <span>
                                    ...
                                    <span class="data">2023.01.04</span>
